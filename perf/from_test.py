...
def countRepertoire(token, config, rep):
    ...
    url = 'https://' + config['api_server'] + '/meta/v3/' + config['dbname'] + '/rearrangement_0?pagesize=1000&page=10&filter=' + requests.utils.quote('{"repertoire_id":"' + rep + '"}') + '&' + requests.utils.quote('sort={}')
    print(url)
