...
# Does a DELETE of an index from the collection
def deleteIndex(token, config, collection, name):
    headers = {
...
if (__name__=="__main__"):
    parser = argparse.ArgumentParser(description='Delete index for collection.')
    ...
    if args:
        ...
        deleteIndex(token, config, args.collection, args.index_name)
